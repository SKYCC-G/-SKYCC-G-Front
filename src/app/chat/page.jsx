  ...
  return (
    <div className="w-screen h-screen bg-white translate-y-[-25px] translate-x-[-20px]">
      <div className="flex h-full">
        <div className="w-full h-full overflow-scroll  bg-lime-200/75">
          <div className="container flex flex-col w-full h-full m-auto">
            <div className="flex flex-row justify-between py-4 flex-2 ">
      ...
      <div className="absolute bottom-0 flex w-full px-2 py-3 bg-white">
        ...
        <div className="flex w-11/12 bg-gray-100 shadow write rounded-3xl">
          <div className="flex-2">
            <textarea
              style={{ outline: "none" }}
              name="message"
              className="block w-full px-4 py-4 bg-transparent border-0 focus:ring-0"
              rows="1"
